...
data class ChecklistItemDto(
    @SerializedName("idChecklist") val idChecklist: Int, // O JSON devolve "idChecklist" (PascalCase ou camelCase, Gson gere)
    @SerializedName("nome") val nome: String,
    @SerializedName("tipo") val tipo: Int,
    @SerializedName("verificado") val verificado: Int? = null,
    @SerializedName("incluido") val incluido: Int? = null,
    @SerializedName("controloFinal") val controloFinal: Int? = null
)
